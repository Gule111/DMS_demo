create table dms_demo.biz_appointments
(
    ...
    subject          tinyint  default 2                 null comment '科目: 2-科目二, 3-科目三',
    status           tinyint  default 1                 null comment '状态: 1-已预约, 2-已完成, 3-已取消',
    created_at       datetime default CURRENT_TIMESTAMP null comment '预约时间'
)
    comment '约课预约表' charset = utf8mb4;
...
create table dms_demo.biz_instructor_schedule
(
    id            bigint auto_increment comment '主键'
        primary key,
    instructor_id bigint               not null comment '教练ID',
    ...
    is_busy       tinyint(1) default 0 null comment '是否忙碌 (1-忙碌, 0-空闲)'
)
    comment '教练档期表' charset = utf8mb4;
...
(
    ...
    avatar           varchar(255)              null comment '教练头像URL',
    phone            varchar(20)               not null comment '联系电话',
    teach_type       varchar(50)               null comment '准教车型',
    experience_years int           default 0   null comment '教龄',
    intro            text                      null comment '个人介绍',
    rating           decimal(3, 1) default 5.0 null comment '评分',
...
create table dms_demo.biz_training_records
(
    id            bigint auto_increment comment '主键'
        primary key,
    student_id    bigint                             not null comment '学员ID',
    ...
    content       text                               null comment '训练内容/教练评价',
    created_at    datetime default CURRENT_TIMESTAMP null comment '录入时间'
)
    comment '训练记录表' charset = utf8mb4;
